...
class Piano : AppCompatActivity() {
    ...
    private val octaveColor = arrayOf<String>("#999999","#E3BA44","#8ACD42","#65C491","#5F90DF","#8350E2","#C2389A","#D85246", "#999999")
    ...
    private fun setBlackKeyRightMargin(newKey: String, whiteKeyWidth: Int): Int {
        val twoTilesDist: Int = (whiteKeyWidth * 1.67).roundToInt()
        val oneTileDist: Int = (whiteKeyWidth * 0.34).roundToInt()
        when {
            newKey.contains("bb7") -> return oneTileDist
            newKey.contains("bb") -> return twoTilesDist
            newKey.contains("db") -> return oneTileDist
            newKey.contains("eb") -> return twoTilesDist
